      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="mt-4 w-full py-2 px-4 border border-zinc-300 dark:border-zinc-700 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors flex items-center justify-center gap-2"
          >
